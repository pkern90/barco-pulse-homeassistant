...
class BarcoLaserPowerNumber(BarcoEntity, NumberEntity):
    ...
    async def async_set_native_value(self, value: float) -> None:
        """Set the laser power."""
        await self.coordinator.device.set_laser_power(value)
...
class BarcoContrastNumber(BarcoEntity, NumberEntity):
    ...
    async def async_set_native_value(self, value: float) -> None:
        """Set the contrast."""
        await self.coordinator.device.set_contrast(value)
        await self.coordinator.async_request_refresh()
...
class BarcoSaturationNumber(BarcoEntity, NumberEntity):
    ...
    async def async_set_native_value(self, value: float) -> None:
        """Set the saturation."""
        await self.coordinator.device.set_saturation(value)
        await self.coordinator.async_request_refresh()
...
class BarcoHueNumber(BarcoEntity, NumberEntity):
    ...
    async def async_set_native_value(self, value: float) -> None:
        """Set the hue."""
        await self.coordinator.device.set_hue(value)
        await self.coordinator.async_request_refresh()
